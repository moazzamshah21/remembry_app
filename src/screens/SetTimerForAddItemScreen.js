...
const SetTimerForAddItemScreen = ({navigation, route}) => {
  ...
  const handleOnPressContinue = () => {
    ...
    navigation.navigate('CreateAddItem', {time: formattedDate});
    // } else {
    //   showMessage({
  ...
  return (
    <React.Fragment>
      <SecondHeader
        ...
        subTitle="ACCORDING TO YOUR DAILY ROUTINE HERE"
...
export default SetTimerForAddItemScreen;
